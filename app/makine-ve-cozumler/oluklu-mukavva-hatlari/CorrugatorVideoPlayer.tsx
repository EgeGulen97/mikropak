...
const YOUTUBE_EMBED_URL =
  "https://www.youtube-nocookie.com/embed/UAAdGexK1pg?autoplay=1&controls=1&modestbranding=1&rel=0&iv_load_policy=3&showinfo=0&mute=0&playsinline=1";

const VIDEO_ID = "UAAdGexK1pg";
...
export default function CorrugatorVideoPlayer() {
    ...
    <>
      <div className="group relative overflow-hidden bg-slate-900">
        <div className="relative aspect-video w-full">
          <Image
            src={thumbSrc}
            alt="Oluklu mukavva hattı video önizleme görseli"
            fill
          ...
          <button
            ...
            className="absolute inset-0 z-10 flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
          >
            <VideoPlayButton />
          </button>
        </div>
          ...
          <div className="relative w-full max-w-5xl overflow-hidden rounded-[14px] bg-black shadow-2xl">
            ...
            <div className="relative aspect-video w-full">
              <iframe
                ...
                title="Oluklu mukavva hattı videosu"
